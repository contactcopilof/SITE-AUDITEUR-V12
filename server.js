        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center gap-3">
                     <!-- Button Contact WhatsApp deleted as requested -->
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="max-w-4xl mx-auto text-center">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <a href="#contact" class="w-full sm:w-auto px-8 py-4 bg-accent-600 hover:bg-accent-500 text-white rounded-lg font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-accent-500/30 flex items-center justify-center gap-2 transform hover:-translate-y-1">
                    ...
                    <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg shadow-brand-900/5 border border-brand-100 overflow-hidden">
                            ...
                            <div class="p-6 md:p-8 space-y-8">
                                <div class="relative pl-10" data-aos="fade-up"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">1</div><h4 class="text-lg font-bold text-slate-900 mb-2">Enjeux réglementaires et cadre QUALIOPI V9</h4><p class="text-slate-600 text-sm leading-relaxed">Cadre légal de la certification, finalités de QUALIOPI, logique et pratiques des organismes certificateurs.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="100"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">2</div><h4 class="text-lg font-bold text-slate-900 mb-2">Lecture experte du Référentiel QUALIOPI V9</h4><p class="text-slate-600 text-sm leading-relaxed">Analyse approfondie des critères et indicateurs, preuves attendues, zones de fragilité fréquemment constatées en audit.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="200"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">3</div><h4 class="text-lg font-bold text-slate-900 mb-2">Fondamentaux de l’audit selon l’ISO 19011</h4><p class="text-slate-600 text-sm leading-relaxed">Principes de l’audit, cycle d’audit, compétences clés de l’auditeur QUALIOPI.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="300"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">4</div><h4 class="text-lg font-bold text-slate-900 mb-2">Impartialité, compétence et déontologie</h4><p class="text-slate-600 text-sm leading-relaxed">Posture professionnelle, indépendance, gestion des situations sensibles et des conflits d’intérêts.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="400"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">5</div><h4 class="text-lg font-bold text-slate-900 mb-2">Préparer un audit comme un certificateur</h4><p class="text-slate-600 text-sm leading-relaxed">Définition du périmètre, plan d’audit, échantillonnage, construction de check-lists opérationnelles.</p></div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg shadow-brand-900/5 border border-brand-100 overflow-hidden">
                            ...
                            <div class="p-6 md:p-8 space-y-8">
                                <div class="relative pl-10" data-aos="fade-up"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">6</div><h4 class="text-lg font-bold text-slate-900 mb-2">Techniques d’audit et entretiens efficaces</h4><p class="text-slate-600 text-sm leading-relaxed">Questionnement, analyse documentaire, collecte et qualification des preuves.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="100"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">7</div><h4 class="text-lg font-bold text-slate-900 mb-2">Écarts et non-conformités : logique de qualification</h4><p class="text-slate-600 text-sm leading-relaxed">Comprendre ce qui déclenche réellement une non-conformité et comment elle est formulée.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="200"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">8</div><h4 class="text-lg font-bold text-slate-900 mb-2">Rédaction du rapport d’audit QUALIOPI V9</h4><p class="text-slate-600 text-sm leading-relaxed">Structure attendue, rédaction factuelle, restitution professionnelle des constats.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="300"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">9</div><h4 class="text-lg font-bold text-slate-900 mb-2">Audit QUALIOPI V9 simulé – cas pratiques</h4><p class="text-slate-600 text-sm leading-relaxed">Audit complet basé sur des situations réelles issues du terrain.</p></div>
                                <div class="relative pl-10" data-aos="fade-up" data-aos-delay="400"><div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 font-bold text-sm">10</div><h4 class="text-lg font-bold text-slate-900 mb-2">Se professionnaliser durablement</h4><p class="text-slate-600 text-sm leading-relaxed">Positionnement professionnel, limites de mission, crédibilité face aux acteurs du marché.</p></div>
                            </div>
                        </div>
                    </div>
...
// Route principale : renvoie le HTML directement
app.get('/', (req, res) => {
  res.send(htmlContent);
});

// Fallback pour toutes les routes (SPA behavior)
app.get('*', (req, res) => {
  res.send(htmlContent);
});
